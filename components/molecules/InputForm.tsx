  ...
  return (
    <View>
      <YStack gap={18}>
        <View
          display={
            !isNil(props.visibleInputWithIcons) && props.visibleInputWithIcons
              ? 'flex'
              : 'none'
          }>
          <InputWithIcons
      ...
      <View
        marginTop={'25%'}
        display={
          !isNil(props.visibleSpace) && props.visibleSpace ? 'flex' : 'none'
        }
      />
      ...
      <YStack gap={20} marginTop={20}>
        ...
        <View flexDirection="row" alignItems="center" justifyContent="center">
          ...
          <Text marginHorizontal={20} color={colors.text}>
            Hoặc
          </Text>
          <Separator borderColor={colors.oceanMist} />
        </View>
